...
#define UI_BORDER_COLOR         rgb_t(0xff,0x00,0x00,0x00)
#define UI_BACKGROUND_COLOR     rgb_t(0xff,0xcc,0xcc,0xcc)
#define UI_GFXVIEWER_BG_COLOR   rgb_t(0xff,0x00,0x00,0x00)
#define UI_GREEN_COLOR          rgb_t(0xff,0x00,0xcc,0x00)
#define UI_YELLOW_COLOR         rgb_t(0xff,0xcc,0xcc,0x00)
#define UI_RED_COLOR            rgb_t(0xff,0xcc,0x00,0x00)
#define UI_UNAVAILABLE_COLOR    rgb_t(0xff,0x40,0x40,0x40)
#define UI_TEXT_COLOR           rgb_t(0xff,0x00,0x00,0x00)
#define UI_TEXT_BG_COLOR        rgb_t(0xff,0xcc,0xcc,0xcc)
#define UI_SUBITEM_COLOR        rgb_t(0xff,0x00,0x00,0xff)
#define UI_CLONE_COLOR          rgb_t(0xff,0x00,0x66,0xff)
#define UI_SELECTED_COLOR       rgb_t(0xff,0xff,0xff,0x00)
#define UI_SELECTED_BG_COLOR    rgb_t(0xff,0x00,0x66,0xff)
#define UI_MOUSEOVER_COLOR      rgb_t(0xff,0xff,0xff,0x80)
#define UI_MOUSEOVER_BG_COLOR   rgb_t(0xff,0x00,0x99,0xff)
#define UI_MOUSEDOWN_COLOR      rgb_t(0xff,0xff,0xff,0x00)
#define UI_MOUSEDOWN_BG_COLOR   rgb_t(0xff,0x00,0x66,0xff)
#define UI_DIPSW_COLOR          rgb_t(0xff,0x66,0x66,0x66)
#define UI_SLIDER_COLOR         rgb_t(0xff,0x00,0xff,0x00)
