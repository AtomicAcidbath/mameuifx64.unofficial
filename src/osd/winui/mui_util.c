...
static void InitDriversInfo(void)
{
	...
	for (ndriver = 0; ndriver < total; ndriver++)
	{
		...
		gameinfo->isImperfect = ((gamedrv->flags & (GAME_UNEMULATED_PROTECTION | GAME_WRONG_COLORS | GAME_IMPERFECT_COLORS |
									GAME_IMPERFECT_GRAPHICS	| GAME_NO_SOUND | GAME_IMPERFECT_SOUND)) != 0);
