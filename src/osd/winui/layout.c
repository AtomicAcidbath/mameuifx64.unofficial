...
extern const DIRECTORYINFO g_directoryInfo[] =
{
	...
	{ "Cheat files",           GetCheatDir,     SetCheatDir,     FALSE, DIRDLG_CHT },
	...
	{ "Extra screenshots",     GetExtraDir,     SetExtraDir,     FALSE, 0 },
...
{
	{ ID_HELP_CONTENTS,		TRUE,	MAMEUIHELP "::/html/mameui_help.htm" },
